...
cl = LINETCR.LINE()
cl.login(token="EpbJsxc73TwjyrpwC6Ac.nzI7ft5uCiGAf8fFerTwpa.mUL/B6eunipyfw0qd88XQ2am0PvTbNKriDe8VUnidA0=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpeqrOGTVprVAuS7WDj6.qdoJ0H7AQUeDXUofPn+ybG.IfpnCb0q21VAFd77J/5YhW+w9VAOfXx61l9kbEKYCak=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="Ep74bXxWeUpNgFwRotqb.YECQYNfv1gBXPlT/yuLe2W.dMPhVug71iskJsqZ0xqIMz/ueMKVxQwCSjQM+A9QkEQ=")
ki2.loginResult()
...
Bots=[mid,kimid,ki2mid,"u25418630a2952d6e99b2ec6df86ae9d3"]
owner =["u25418630a2952d6e99b2ec6df86ae9d3"]
admin = ["u25418630a2952d6e99b2ec6df86ae9d3"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#--------===---====--------------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              #if msg.from_ in admin:
                cl.sendText(msg.to, "Okey Boss,, Siap Laksanakan Perintah, ,,!!!?")
                try:
                ...
                #print wait2
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Sider dulu Cuy\nBaru Ketik Read\nDASAR PIKUN ♪")
#-----------------------------------------------
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Team NB Mau Bersih² Group Sampah Nih")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                ki.sendText(msg.to,"Okey Segera Merapat")
                ki2.sendText(msg.to,"Siap Laksanakan Perintah Boss")
      ...
      #-------------Fungsi Chat ----------------
                 ...
                 quote = ['Istri yang baik itu Istri yang Mengizinkan Suaminya untuk Poligami 😂😂😂.','Kunci Untuk Bikin Suami Bahagia itu cuma satu..\nIzinkan Suamimu Untuk Selingkuh Coyyy ','Ah Kupret Lu','Muka Lu Kaya Jamban','Ada Orang kah disini?','Ada Perawan Nganggur ga Coy?']
    ...
    for zx in range(0,200):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐NB.NINJA BLACK⭐⭐👈\n\n™By ✰NB.NINJA BLACK✰")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✰NB.NINJA BLACK✰")
                    print "Like"
                except:
                    pass
            else:
